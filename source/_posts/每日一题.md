...
- sticky
  sticky定位即粘性定位，可以简单地认为是相对定位和固定定位的混合，元素在跨越特定阈值前为相对定位，之后为固定定位。

- inherit
  继承父类的postion值，不会继承其left、top、right及bottom值
  <iframe src="https://github.com/fengyueran/css-demo-sets/blob/master/css3-sticky-demo/demo1.html" width="700px" height="500px" frameborder="0" scrolling="no"> </iframe>
