...
git的命令很多，为了减少后续查询的时间在这里列出了平常用到的一些命令。关于这些命令我们需要对git有一个基本的认识，如下图，展示了git的几个分区以及基本操作。
<img style="display:block; margin: auto; width: 500px" alt="行盒子结构示意图"  src="https://i.imgur.com/UZwXbrV.png"  />
